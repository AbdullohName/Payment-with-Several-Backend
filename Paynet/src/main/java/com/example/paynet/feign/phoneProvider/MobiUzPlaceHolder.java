...
@FeignClient(value = "mobiUz",url = "http://localhost:9001/api",configuration = MyClientConfiguration.class)
public interface MobiUzPlaceHolder {
    @RequestMapping(method = RequestMethod.POST,value = "/mobiuz",produces = "application/json")
    ResponseDto<String> MobiUz(@RequestBody PhoneNumberPaymentDto phoneNumberPaymentDto);
